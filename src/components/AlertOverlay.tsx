    ...
    <>
      ...
      >
        ...
        <div className="w-full pt-12 px-6 text-center">
          ...
          {/* Alert message */}
          <p className="text-xl md:text-2xl font-bold text-red-100 mb-4">{alert.message}</p>

          {/* Location info */}
          <div className="inline-block bg-black/30 backdrop-blur-sm rounded-lg px-6 py-3 mb-4">
            <p className="text-white font-semibold text-lg">📍 {alert.location}</p>
          </div>
        ...
        <div className="w-full pb-16 px-6">
          <div className="max-w-md mx-auto flex items-center justify-around gap-8">
            {/* Reject button */}
            <button onClick={handleReject} className="group flex flex-col items-center gap-3">
            ...
            {/* Mute button */}
            <button onClick={handleToggleSound} className="group flex flex-col items-center gap-3">
            ...
            <button onClick={handleAcknowledge} className="group flex flex-col items-center gap-3">
          ...
          <div className="mt-8 text-center">
            <p className="text-red-200/70 text-sm">Tekan tombol untuk merespons alert</p>
          </div>
        </div>
      </div>
